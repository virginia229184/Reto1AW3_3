...
public class XMLForm extends JFrame {
	...
	public XMLForm() {
		...
		btnGenerarSesion.setBounds(196, 441, 160, 32);
		...
		btnGenerarReserva.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Controlador.Coordinador.importarXMLLL();
				} catch (SQLException | IOException | ParserConfigurationException | SAXException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
			}
		});
		btnGenerarReserva.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnGenerarReserva.setBackground(new Color(251, 207, 76));
		btnGenerarReserva.setBounds(387, 441, 160, 32);
